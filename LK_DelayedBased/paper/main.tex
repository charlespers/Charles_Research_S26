...
All timing benchmarks use the Princeton Adroit cluster (NVIDIA A100, CUDA 12.x)
unless otherwise noted; GPU acceleration is via JAX \citep{bradbury2018jax}.
...
\begin{figure}[t]
  ...
  \caption{%
    ...
    sample under three coupling motifs (with spontaneous-emission noise).}
    Dashed vertical line marks the 10\,ns washout boundary.
    The coupling topology shapes the inter-laser synchronization and
    temporal modulation patterns visible after the washout period.
  }
